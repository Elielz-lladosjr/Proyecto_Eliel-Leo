...
// Nota: Ya no importamos 'Headset' porque usaremos tu imagen
    ...
    <footer className={`${styles.customFooter} text-white py-5`}>
      <div className="container">
        ...
        <div className="row gy-4">
          ...
          {/* ... (Las columnas de Cliente, Trabajador, Proveedor y Sociedad siguen igual) ... */}
          ...
          {/* --- COLUMNA 5: CONTACTO (CAMBIO AQUÍ) --- */}
          <div className="col-12 col-md-4 text-md-end">
            ...
            <div className="d-flex align-items-center justify-content-md-end mb-3">
              ...
              {/* AQUÍ PONES TU RUTA */}
              <img 
                src="/imagenes/footer1.png" 
                alt="Teléfono" 
                width="32" 
                height="32" 
                className="me-2" // Esto añade un margen a la derecha (Bootstrap)
                style={{ objectFit: 'contain' }} // Para que no se deforme
              />
